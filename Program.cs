...
Console.WriteLine("Digite um número decimal para ser convertido para binário: "); int numero; 
bool validacaoDoDigito = int.TryParse(Console.ReadLine(), out numero); 
if (validacaoDoDigito == false) 
{ 
Console.WriteLine("Digito inválido. Por favor, insira um numero decimal válido."); Console.WriteLine("Aperte enter para voltar para inserir outro numero! "); Console.ReadKey(); 
Console.Clear(); 
Opcao1(); 
} 
Console.WriteLine("|------------------------------------------------------------------|"); 
...
Console.WriteLine("Digite um número binário para ser convertido para decimal: "); int binario; 
bool validacaoDoDigito = int.TryParse(Console.ReadLine(), out binario); 
if (validacaoDoDigito == false) 
{ 
Console.WriteLine("Digito inválido. Por favor, insira um numero Binário válido."); Console.WriteLine("Aperte enter para voltar para inserir outro numero! "); Console.ReadKey(); 
Console.Clear(); 
Opcao2(); 
} 
string inverso = new string(binario.ToString().Reverse().ToArray()); 
if (string.IsNullOrEmpty(inverso) || !inverso.All(c => c == '0' || c == '1')) { 
Console.WriteLine("Número inválido. Por favor, insira um número binário válido."); Console.WriteLine("Aperte enter para inserir outro numero!"); 
Console.ReadKey(); 
Opcao2(); 
}
Console.WriteLine("|------------------------------------------------------------------|"); double soma = 0; 
double posicao = 0; 
...
Console.WriteLine("Digite um número decimal para ser convertido para octal: "); int numero; 
bool validacaoDoDigito = int.TryParse(Console.ReadLine(), out numero); 
if (validacaoDoDigito == false) 
{ 
Console.WriteLine("Digito inválido. Por favor, insira um numero decimal válido."); Console.WriteLine("Aperte enter para voltar para inserir outro numero! "); Console.ReadKey(); 
...
Console.WriteLine("|------------------------------------------------------------------|"); quociente = numero / 8; 
resto = numero % 8; 
resultado.Add(resto);
...
Console.WriteLine("Digite um número octal para ser convertido para decimal: "); int numero; 
bool validacaoDoDigito = int.TryParse(Console.ReadLine(), out numero); 
if (validacaoDoDigito == false) 
{ 
Console.WriteLine("Digito inválido. Por favor, insira um numero octal válido."); Console.WriteLine("Aperte enter para voltar para inserir outro numero! "); Console.ReadKey(); 
Console.Clear(); 
Opcao4(); 
} 
string inverso = new string(numero.ToString().Reverse().ToArray()); 
if (string.IsNullOrEmpty(inverso) || !inverso.All(c => c >= '0' && c <= '7')) {
Console.WriteLine("Esse numero eh inválido. Digite um número em octal."); Console.WriteLine("Aperte enter para inserir outro numero!"); 
Console.ReadKey(); 
Console.Clear(); 
Opcao4(); 
} 
...
Console.WriteLine("Aperte enter para voltar para inserir outro numero! "); Console.ReadKey();
Console.Clear(); 
Opcao5(); 
} 
Console.WriteLine("|------------------------------------------------------------------|"); while (quociente != 0) 
{ 
quociente = numero / 16; 
resto = numero % 16; 
if (resto <= 9) 
...
string numeroinvertido = new string(hex.ToString().Reverse().ToArray()); Console.Write("Resultado: " + numeroinvertido); 
Console.WriteLine("\n"); 
Console.WriteLine("Aperte enter para voltar pro Menu! ");
Console.ReadKey(); 
Console.Clear(); 
...
Console.WriteLine("Insira um número binário para ser convertido em octal: "); numero = Console.ReadLine(); 
int num = Convert.ToInt32(numero); 
if (string.IsNullOrEmpty(numero) || !numero.All(c => c == '0' || c == '1')) { 
Console.WriteLine("Digito invalido. Digite um número binário válido."); Console.WriteLine("Aperte enter para voltar para inserir outro numero! "); Console.ReadKey(); 
Console.Clear(); 
Opcao7(); 
} 
Console.WriteLine("|------------------------------------------------------------------|"); for (int i = 0; i <= numero.Length - 1; i++)
{ 
count = count + 1; 
if (count == 3) 
{ 
...
Console.WriteLine("Aperte enter para voltar pro Menu! "); Console.ReadKey(); 
Console.Clear(); 
Menu(); 
} 
...
Console.WriteLine("Insira um número octal para conversão em binário: "); string octal = Console.ReadLine(); 
...
Console.WriteLine("Insira o número binário para ser convertido em hexadecimal: "); numero = Console.ReadLine(); 
if (string.IsNullOrEmpty(numero) || !numero.All(c => c == '0' || c == '1')) { 
Console.WriteLine("Número inválido. Por favor, insira um número binário válido."); Console.WriteLine("Aperte enter para voltar para inserir outro numero! "); Console.ReadKey();
Console.Clear(); 
Opcao9(); 
} 
Console.WriteLine("|------------------------------------------------------------------|"); for (int i = 0; i <= numero.Length - 1; i++) 
...
Console.WriteLine("Insira um número hexadecimal para conversão em binário: "); numero = Console.ReadLine().ToUpper(); 
if (string.IsNullOrEmpty(numero) || !numero.All(c => (c >= '0' && c <= '9') || (c >= 'A' && c <= 'F'))) 
{ 
Console.WriteLine("Número inválido. Digite um número hexadecimal válido."); Console.WriteLine("Aperte enter para voltar para inserir outro numero! "); Console.ReadKey(); 
Console.Clear(); 
Opcao10(); 
} 
Console.WriteLine("|------------------------------------------------------------------|"); for (int i = 0; i < numero.Length; i++) 
{ 
...
break; 
case "4": 
hexadecimal += "0100"; Console.Write("4 = 0100 "); break; 
case "5": 
hexadecimal += "0101"; Console.Write("5 = 0101 "); break; 
case "6": 
hexadecimal += "0110"; Console.Write("6 = 0110 "); break; 
case "7": 
hexadecimal += "0111"; Console.Write("7 = 0111 "); break; 
case "8": 
hexadecimal += "1000"; Console.Write("8 = 1000 "); break; 
case "9": 
hexadecimal += "1001"; Console.Write("9 = 1001 "); break; 
case "A": 
hexadecimal += "1010"; Console.Write("A = 1010 "); break; 
case "B": 
hexadecimal += "1011"; Console.Write("B = 1011 "); break; 
case "C": 
hexadecimal += "1100"; Console.Write("C = 1100 "); break; 
case "D": 
hexadecimal += "1101"; Console.Write("D = 1101 "); break; 
case "E": 
hexadecimal += "1110"; Console.Write("E = 1110 "); break; 
case "F": 
hexadecimal += "1111"; Console.Write("F = 1111 ");
break; 
} 
} 
...
Console.WriteLine("Digite um número octal para ser convertido para hexadecimal: "); string octal = Console.ReadLine(); 
if (string.IsNullOrEmpty(octal) || !octal.All(c => c >= '0' && c <= '7')) 
{ 
Console.WriteLine("Esse numero eh inválido. Digite um número em octal."); Console.WriteLine("Aperte enter para voltar para inserir outro numero! "); Console.ReadKey(); 
Console.Clear(); 
Opcao11(); 
} 
Console.WriteLine("|------------------------------------------------------------------|"); int dec = 0; 
...
Console.WriteLine("O numero em octal " + octal + " eh passado para deciamal " + dec); Console.WriteLine(); 
int contador = 1; 
int resto, quociente = 1; 
string hex = ""; 
int numero = dec; 
...
Console.WriteLine("Informe um número hexadecimal para ser convertido para octal: "); string numero = Console.ReadLine().ToUpper(); 
if (string.IsNullOrEmpty(numero) || !numero.All(c => (c >= '0' && c <= '9') || (c >= 'A' && c <= 'F'))) 
{ 
Console.WriteLine("Número inválido. Por favor, insira um número hexadecimal válido."); 
Console.WriteLine("Aperte enter para voltar para inserir outro numero! "); Console.ReadKey(); 
...
{ 
case 0: 
Console.WriteLine("Programa encerrado"); break; 
case 1: 
Opcao1(); 
break; 
case 2: 
...
{ 
Console.WriteLine("Digite um núemro que tenha no Menu!"); Console.WriteLine("Aperte enter para voltar pro Menu! "); Console.ReadKey(); 
Console.Clear(); 
Menu(); 
} 
} 
...
Console.WriteLine("|------------------------------------------------------------------|"); Console.WriteLine(" 1: Decimal --> Binário"); 
...
Console.WriteLine("|------------------------------------------------------------------|"); Console.WriteLine(" 0: Sair da calculadora"); 
Console.WriteLine("Digite um número para fazer a conta: "); int escolha; 
bool validacaoDoDigito = int.TryParse(Console.ReadLine(), out escolha);
if (validacaoDoDigito == false) 
{ 
Console.WriteLine("Você digitou uma letra ou caracter inesperada"); Console.WriteLine("Aperte enter para voltar pro Menu! "); Console.ReadKey(); 
Console.Clear(); 
Menu(); 
} 
do 
